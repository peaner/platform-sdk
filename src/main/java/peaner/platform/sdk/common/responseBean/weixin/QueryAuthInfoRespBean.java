...
/**
 * @Author: lilongzhou
 * @Description: 使用授权码换取公众号或小程序的接口调用凭据和授权信息返回参数
 * @Date: Created in 下午3:24 2018/11/11
 */
@Setter
@Getter
public class QueryAuthInfoRespBean {
     ...
     * 刷新令牌主要用于第三方平台获取和刷新已授权用户的access_token，只会在授权时刻提供，
     ...
     * 22、城市服务接口权限 23、广告管理权限 24、开放平台帐号管理权限
     * 25、 开放平台帐号管理权限（小程序）
